...
def main():
    ...
    file_data.plot_dataframe_signal.connect(
        window.main_tab.plot_canvas.plot_file_data_from_dataframe)
    ...
    window.main_tab.active_file_modify_signal.connect(
        calcultaions.modify_active_file_slot)

    window.main_tab.calculations_data_modify_signal.connect(
        calcultaions.modify_calculations_data_slot)

    calcultaions.plot_reaction.connect(
        window.main_tab.plot_canvas.plot_reaction)
    ...
    window.main_tab.processing_signal.connect(
        calcultaions.calc_data_operations_in_progress)
